module.exports = nativeDescription: "Türkçe", englishDescription: "Turkish", translation:
  ...
  new_home:
    ...
    meta_description: "Programlama oyunlarıyla kod yazmayı öğrenin. Python, JavaScript, ve HTML bulmaca çözerek öğrenin, kodlamanızla kendi oyununuzu ve web sitenizi yaratınız."
...
#    become_investor: "to become an investor in CodeCombat"
    ...
    built_for_teachers_subblurb2: "Öğrenciler temel giriş işlemlerini kullanarak arkadaşlarıyla ve ailesiyle paylaşabilecekleri kendi laberinlerini oluştururlar."
    built_for_teachers_subtitle3: "Web Geliştirme"
    built_for_teachers_subblurb3: "HTML, CSS ve jQuery kullanarak özel URL-adreslerde yaratıcılığını kullanarak kendi web sitelerini oluştururken kendilerini geliştirirler, ardından oluşturdukları sayfaları arkdaşlarıyla paylaşabilirler."
    ...
    century_skills_quote1: "Takıldın... Çözüm için olası tüm yolları gözden geçir ve tekrar dene. Ben buralara çalışmadan gelemezdim."
    century_skills_subtitle1: "Eleştirel Düşünme"
    century_skills_subblurb1: "Doğal olarak zorluk derecesinin arttığı programlama bulmacalarının sayesinde, CodeCombat öğrencilerin her daim eleştirel düşünme konusunda pratik yaptıklarını garanti eder."
    ...
    century_skills_subblurb2: "CodeCombat öğrencilerin kendi oluşturdukları oyun ve web sitelerini yaymalarına olanak tanır ve yaratıcılığını göstermeleri için teşvik eder."
    century_skills_quote3: "Eğer bir seviyede takılırsam. Etrafımdaki insanlarla konu hakkında çözüme ulaşanadek çalışacağım."
    century_skills_subtitle3: "İş Birliği"
    century_skills_subblurb3: "Oyunda, öğrenciler takıldıklarında her daim iş birliği yapmaları mümkün ve eşli programlama yönlendirmelerimizi kullanarak beraber çözüm üretebilirler."
    century_skills_quote4: "Ben her zaman video oyun geliştirmeye ve programlamaya çalıştım... bu benim için iyi bir referans noktası olmuştur."
    century_skills_subtitle4: "İletişim"
    century_skills_subblurb4: "Programlama çocuklardan yeni tür iletişim becerilerini geliştirmlerine neden olur, bununla birlikte bilgisayarla iletişimin ve fikirlerini iletebildikleri daha etkili bir kod kullanmalarına."
    classroom_in_box_title: "Biz hedefliyoruz:"
    classroom_in_box_blurb1: "Her bir öğrenciyi içeri sürükleyin ki programlamanın mümkün olduğuna inansınlar."
    classroom_in_box_blurb2: "Her eğitmenin kodlama öğretirken kendinden emin hissetmesine imkan tanı."
    classroom_in_box_blurb3: "Her okul liderini dünya çapında bilgisayar bilimi alanında program üretmesini teşvik ediniz."
#    classroom_in_box_blurb4: ""
    covid19_banner_blurb: "Pandemiden etkilenen okul ve eğitmenlere ücretsiz erişim tanıyoruz."
#    click_here: "Click here"
    creativity_rigor_title: "Yaratıcılığın titizlikle buluştuğu alan"
    creativity_rigor_subtitle1: "Programlamayla gerçek becerilere sahip olun"
    creativity_rigor_blurb1: "Öğrenciler deneme-yanılmaların teşvik edildiği oyunları oynarken gerçek Python ve JavaScript kullanmkta."
    creativity_rigor_subtitle2: "Öğrencilere kendi seviyelerinde ulaşın"
    creativity_rigor_blurb2: "CodeCombat'ın seviyeleri her bir öğrenciye hitap edebilmek için milyonlarca veri noktalarından oluşmaktadır. Egzersiz seviyeleri ve ipuçları öğrencilere takıldıkları noktada yardımcı olurlar ve oyun boyunca öğrencileri değerlendirirler."
    creativity_rigor_subtitle3: "Tüm eğitmenler için geliştirildi, deneyime bakmaksızın"
    creativity_rigor_blurb3: "Bağımsız, standlaştırılmış CodeCombat eğitimi bilgisayar biliminin herkes için mümkün kılar. CodeCombat eğitmenlerin sınıf içinde bilgin olmaları için öğrenme kaynaklarını ve özel desteğini sunar."
    featured_partners_title1: "Kanıtlanmış"
    featured_partners_title2: "Ödüller & Ortaklar"
#    featured_partners_blurb1: "Clever Partner"
    featured_partners_blurb2: "Öğrenciler İçin En İyi Yaratıcılık Aracı"
    featured_partners_blurb3: "Eğitim İçin En İyi Tercih"
    featured_partners_blurb4: "Code.org Resmi Ortak"
    featured_partners_blurb5: "CSforAll Resmi Üye"
    featured_partners_blurb6: "Hour of Code Ortak"
    for_leaders_title: "Okul Liderleri İçin"
    for_leaders_blurb: "Kapsamlı standartlaştırılmış bilgisayar bilimi programı"
    for_leaders_subtitle1: "Basit Uygulanış"
    for_leaders_subblurb1: "Web tabanlı yazılım BT desteğine ihtiyaç duymaz. 5 dakikadan az bir sürede başlayın, bunun için Google veya Clever Single Sign-On (SSO) kullanmanız yeterli."
    for_leaders_subtitle2: "Tamamen Kodlama Müfredatı"
    for_leaders_subblurb2: "Öğretim kaynaklı ve uzman geliştirmeli standartlaştırılmış eğitmen müfredatı, eğitimcilerin bu eğitimi verme olanağı tanır." # {change}
    for_leaders_subtitle3: "Esnek kullanım durımları"
#    for_leaders_subblurb3: "Whether you want to build a Middle School coding elective, a CTE pathway, or are teaching an Intro to CS class, CodeCombat is tailored to suit your needs."
    for_leaders_subtitle4: "Gerçek-alan becerileri"
#    for_leaders_subblurb4: "Students build grit and develop a growth mindset through coding challenges that prepare them for the 500K+ open computing jobs."
    for_teachers_title: "Eğitmenler için"
    for_teachers_blurb: "Öğrenci potansiyelini keşfetme araçları"
    for_teachers_subtitle1: "Proje bazlı eğitim"
    for_teachers_subblurb1: "Öğrencilerin geliştirdikleri kendi oyun ve web site çalışmalarında yaratıcılıklarına destek olunuz."
    for_teachers_subtitle2: "Eğitmen paneli"
...
#    game_based_blurb: "CodeCombat is a game-based computer science program where students type real code and see their characters react in real time."
    ...
    global_title: "Küresel Öğrenci ve Eğitmen Topluluğuna Katıl"
    global_subtitle1: "Öğrenciler"
    global_subtitle2: "Kod Satırları"
    global_subtitle3: "Eğitmenler"
    global_subtitle4: "Ülkeler"
    go_to_my_classes: "Derslerime git"
    go_to_my_courses: "Kursuma git"
    quotes_quote1: "Herhangi bir online program adı söyleyiniz, ben denedim onu. Hiç biri CodeCombat ile denk değil. Öğrencisinin programlam öğrenmesini isteyen her eğitmen buradan başlamalı!"
...
#    quotes_quote4: "The feedback … has been so positive that we are structuring a computer science class around CodeCombat. The program really engages the students with a gaming style platform that is entertaining and instructional at the same time. Keep up the good work, CodeCombat!"
    see_example: "Örneği Göster"
    slogan: "Programlama öğrenmek için en sürükleyici oyun." # {change}
    teach_cs1_free: "CS1 Ücretsiz Öğret"
    teachers_love_codecombat_title: "Eğitmenler CodeCombat'ı seviyorlar"
#    teachers_love_codecombat_blurb1: "Report that their students enjoy using CodeCombat to learn how to code"
    teachers_love_codecombat_blurb2: "Diğer bilişim eğitmenlerine CodeCombat'ı tavsiye ediyorum"
...
#    top_banner_blurb_team_derbezt_suffix: "to get the exclusive Armando Hoyos hero from Mexican superstar Eugenio Derbez!"
    ...
    classroom_in_a_box: "Bilgisayar bilimleri öğrenmek için kutudan hazır bir sınıf."
    ...
    from_the_first_level: "ilk seviyeden itibaren"
    ...
    forgot_learning: "Büyük olasılıkla öğrendiklerini unutacaklarını düşünüyorum." # {change} upd
    wanted_to_do: " Kodlama her zaman yapmak istediğim birşeydi ve hiçbir zaman bunu okulda öğrenebileceğimi düşünmemiştim."
    builds_concepts_up: "CodeCombat'ın sunduğu programlama kavrmları hoşuma gidiyor, çünkü anlaşılması kolay ve aynı zamanda eğlenceliler."
    ...
    game_based: "Oyun temelli sistemken"
    compared: "kıyaslandı"
...
#    feedback: "Games also provide real-time feedback that allows students to adjust their solution path and understand concepts more holistically, instead of being limited to just “correct” or “incorrect” answers."
    real_game: "Gerçek oyun, gerçek programayla oyna."
...
#    agency: "CodeCombat is a game that gives players that agency and confidence with our robust typed code engine, which helps beginner and advanced students alike write proper, valid code."
    request_demo_title: "Öğrencilerinizle hemen çalışmaya başlayınız!"
    request_demo_subtitle: "Deneme sürümü talep edip öğrencilerinizle 1 saatten az sürede başlayınız."
    get_started_title: "Sınıfınızı hemen düzenleyiniz"
    get_started_subtitle: "Sınıfı düzenleyiniz, öğrenci ekleyip bilişim alanında başarılarını takip ediniz."
    request_demo: "Deneme Sürümü Talep Et"
#    request_quote: "Request a Quote"
    setup_a_class: "Sınıf ayarları"
    have_an_account: "Hesabın var mı?"
    logged_in_as: "Belirtildiği kullanıcı adıyla giriş yaptınız"
#    computer_science: "Our self-paced courses cover basic syntax to advanced concepts"
    ffa: "Tüm öğrenciler için ücretsiz"
    coming_soon: "Yakında!"
...
#    run_class: "Everything you need to run a computer science class in your school today, no CS background required."
    goto_classes: "Sınıflarımı Görüntüle"
    view_profile: "Profilimi Görüntüle"
    view_progress: "İlerlemeyi Görüntüle"
    go_to_courses: "Kurslarımı Görüntüle"
    want_coco: "CodeCombat'ı okulunuzda ister misiniz?"
    educator: "Eğitmen"
    student: "Öğrenci"
...
#    impact: "Impact"
    ...
    schools: "Okullar"
    get_involved: "Katıl"
    open_source: "Açık Kaynak Kod (GitHub)"
    support: "Destek"
    faqs: "SSS"
    copyright_prefix: "Telif hakkı"
    copyright_suffix: "Tüm hakları saklıdır."
    help_pref: "Yardım mı lazım? Yazınız"
    help_suff: "ve biz irtibat kurarız!"
    resource_hub: "Kaynaklar"
    apcsp: "AP CS Prensipleri"
    parent: "Ebeveynlere"
#    esports: "Esports"
    browser_recommendation: "Daha iyi bir deneyim için Chrome tavsiye ediyoruz. Buradan indirebilirsiniz!"
  ...
  diplomat_suggestion:
    ...
    learn_more: "Diplomat nasıl olunur, bilgi al"
...
#    anon_signup_setup_class: "Set up a class, add your students, and monitor progress!"
    ...
    get_course_for_class: "Oyun geliştirmenizi sınıflarınıza ekleyin!"
    request_licenses: "Daha fazla bilgi için okul yetkilerinle iletişime geç."
    compete: "Tamamla!" # Course details page # ~yarış 
    spectate: "İzleyici olarak katıl" # Ladder page
#    simulate_all: "Simulate All"
    players: "oyuncular" # Hover over a level on /play
    ...
    subscriber_heroes: "Amara, Hushbaum, ve Hattori'yi almak için hemen üye ol!"
    subscriber_gems: "Değerli taşlarla bu kahramanı almak için hemen üye ol!"
    anonymous: "Anonim Oyuncu"
    level_difficulty: "Zorluk: "
    awaiting_levels_adventurer_prefix: "Her hafta yeni bölüm yayınlıyoruz." # {change} upd
    ...
    campaign_multiplayer_description: "Diğer oyuncularla programlamada yarışmak için..."
    brain_pop_done: "Kazandınız! Orgları kodla yendiniz!"
    brain_pop_challenge: "Programlama dilini değiştirerek kendini yeteneklerini dene!"
    replay: "Tekrar"
    back_to_classroom: "Sınıfa Geri Dön"
    teacher_button: "Eğitmenler İçin"
    get_more_codecombat: "Daha fazla CodeCombat imkanından yararlan"
  ...
  code:
    ...
    "+": "artı"
    "-": "eksi"
    "+=": "belirtildiği kadar arttır"
    "-=": "belirtildiği kadar azalt"
    True: "Doğru"
    true: "doğru"
    False: "Yanlış"
    false: "yanlış"
    undefined: "tanımsız"
    null: "boş"
    nil: "hiç bir şey (boş gösterim)"
    None: "hiç bir şey (boş gösterim)"
...
#    accounts_merge_confirmation: "There is an account associated with the email from this Google account. Would you like to merge these accounts?"
  ...
  signup:
    ...
    create_teacher_header: "Eğitmen Hesabı Oluştur"
    create_individual_header: "Bireysel Hesap Oluştur"
    email_announcements: "Yeni seviye ve imkanlar hakkında e-posta almak istiyorum" # {change} upd
    sign_in_to_continue: "Devam etmek için giriş yap veya üye ol"
    teacher_email_announcements: "Yeni eğitim kaynaklarından, planlardan ve kurslardan haberdar olmak istiyorum!"
    creating: "Hesap oluşturuluyor..."
    sign_up: "Kaydol"
    log_in: "parolayla giriş yap" #upd
    login: "Giriş"
    required: "Devam etmek için giriş yap." # upd
    login_switch: "Zaten bir hesabın var mı?"
    optional: "isteğe bağlı"
    connected_gplus_header: "Google+ ile başarıyla bağlandın!"
    connected_gplus_p: "Artık Google+ hesabınla giriş yapabilirsin." # upd
    connected_facebook_header: "Facebook ile başarı ile bağlandın!"
    connected_facebook_p: "Artık Facebook hesabınla giriş yapabilirsin." # upd
    hey_students: "Öğrenciler, öğretmeninizin verdiği sınıf kodunu girin."
    birthday: "Doğum günü"
    parent_email_blurb: "Programlamak için sabırsızlandığınızı biliyoruz - bizde sizi bekliyoruz! Ebeveynleriniz ilerleyen talimatlar hakkında mail alacaklardır. Her türlü sorularınız için {{email_link}} adresinden bize geri dönüş yapabilirsiniz."
    classroom_not_found: "Belirtilen kodla sınıf bulunamadı. Kodu kontrol ediniz veya eğitmeninizden yardım isteyiniz."
    checking: "Kontrol ediliyor..."
    account_exists: "Bu e-mail zaten kullanımda:"
    sign_in: "Oturum aç"
    email_good: "E-posta iyi görünüyor!"
    name_taken: "Kullanıcı adı alınmış! Şunu dene {{suggestedName}}" # upd
    name_available: "Kullanıcı adı müsait!"
    name_is_email: "Kullanıcı adı e-mail ile aynı olmamalı"
    choose_type: "Hesabınızın türünü seçin:"
    teacher_type_1: "CodeCombat ile eğitim ver!"
    teacher_type_2: "Sınıfınızı düzenleyiniz"
    teacher_type_3: "Ders Materyellerine Eriş"
    teacher_type_4: "Öğrenci başarısını görüntüle"
    signup_as_teacher: "Öğretmen olarak Kaydol"
    student_type_1: "İlgi çekici bir oyun oynarken program öğren!" # sürükleyici (?)
    student_type_2: "Sınıfınla oyna"
    student_type_3: "Arenalarda rekabet et"
    student_type_4: "Kahramanını seç!"
    student_type_5: "Sınıf kodu al!"
    signup_as_student: "Öğrenci olarak Kaydol"
    individuals_or_parents: "Bireysel & Ebeveynler"
    individual_type: "Sınıf dışında öğrenenler için. Ebeveynler buradan hesap oluşturmalılar."
    signup_as_individual: "Bireysel olarak Kaydol"
    enter_class_code: "Sınıf Kodunu Gir"
    enter_birthdate: "Doğum tarihini gir:"
    parent_use_birthdate: "Ebeveynler, kendi doğum tarihinizi giriniz."
    ask_teacher_1: "Sınıf kodunu öğretmenine sor." # upd
    ask_teacher_2: "Sınıfta yer almıyor musun? Oluştur"
    ask_teacher_3: "Bireysel Hesap"
    ask_teacher_4: " bunun yerine." # yerine (?)
    about_to_join: "Katılıyorsunuz:"
    enter_parent_email: "Ebeveyn e-mail adresini gir:"
    parent_email_error: "E-mail gönderim esnasında bir şeyler ters gitti. E-mail adresini kontrol edip tekrar deneyiniz."
    parent_email_sent: "Ebeveyn e-mail adresine talimatlarla ilgili mail göndermiş olduk. Velinizi epostasını kontrol etmisini rica ediniz."
    account_created: "Hesap Oluşturuldu!"
    confirm_student_blurb: "Bilgilerinizi not ediniz. İhtiyaç durumunda eğitmeniniz parola sıfırlama yetkisine sahiptir."
    confirm_individual_blurb: "İhtiyaç duyulması anı için bilgilerinizi not ediniz. E-mail adresinizi kontrol ediniz, parola sıfırlama durumu için gereklidr - gelen kutusunu kontrol ediniz!"
   write_this_down: "Giriniz:"
    start_playing: "Oynamaya Başla!"
    sso_connected: "Başarıyla bağlandınız:"
    select_your_starting_hero: "İlk kahramanınızı seçiniz:"
    you_can_always_change_your_hero_later: "Dilediğiniz zaman kahramanınızı değiştirebilirsiniz."
    finish: "Bitir"
    teacher_ready_to_create_class: "İlk sınıfınızı oluşturmak için hazırsınız!"
    teacher_students_can_start_now: "Öğrencileriniz ilk kursa başlayabilirler, bilişime giriş, hemen şu an."
    teacher_list_create_class: "Bir sonraki alanda yeni sınıf oluşturabilirsiniz."
    teacher_list_add_students: "Bağlantı ön gösterimden sınıfa öğrencileri ekleyiniz, ardından öğrencilere sınıf kodu veya bağlantısı gönderiniz, varsa e-mail gönderebilirsiniz."
    teacher_list_resource_hub_1: "Gözden geçir"
    teacher_list_resource_hub_2: "Kurs rehberi"
    teacher_list_resource_hub_3: "seviye çözümleri için, ayrıca"
    teacher_list_resource_hub_4: "Kaynaklar"
...
#    complete: "Complete"
  ...
  general:
    ...
    accept: "Kabul Et"
    accept_and_save: "Kabul Et & Kaydet"
    reject: "Reddet"
    withdraw: "Ayrıl"
    submitter: "Gönderen"
    submitted: "Sunan" # upd Gönderilen
    commit_msg: "Gönderme İletisi"
    version_history: "Geçmiş"
    version_history_for: "Sürüm Geçmişi: "
    select_changes: "Farkı görmek için aşağıdan iki değişimi seçin." # upd
    undo_prefix: "Geri Al"
    ...
    first_name: "Ad"
    last_name: "Soyad"
    last_initial: "Soyadın Baş Harfi"
...
#    support: "Support"
  ...
  units:
    second: "saniye"
    seconds: "saniye(ler)" # upd
    sec: "sn"
    minute: "dakika"
    minutes: "dakika(lar)" # upd
    hour: "saat"
    hours: "saat(ler)" # upd
    day: "gün"
    days: "gün(ler)" # upd
  ...
  play_level:
    ...
    finished_hoc: "Kodlama Saatimi tamamlamış oldum"
    get_certificate: "Sertifikanı Al!"
    level_complete: "Seviye Tamamlandı"
    completed_level: "Tamamlanan Seviye:"
    course: "Kurs:"
    done: "Bitti"
    next_level: "Sonraki Seviye:"
    combo_challenge: "Kombo Mücadele"
    concept_challenge: "Konsept Mücadele"
    challenge_unlocked: "Mücadele Açıldı"
    combo_challenge_unlocked: "Kombo Mücadele Açıldı"
    concept_challenge_unlocked: "Konsept Mücadele Açıldı"
    concept_challenge_complete: "Konsept Mücadele Tamamlandı!"
    combo_challenge_complete: "Kombo Mücadele Tamamlandı!"
    combo_challenge_complete_body: "Çok iyi, sanırım __concept__ hakkında bilgiler iyi anlaşılmış!"
    replay_level: "Yeniden Oyna"
    combo_concepts_used: "__complete__/__total__ Kavram Kullanıldı"
